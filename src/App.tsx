      ...
      {feedback && (
        <g>
          <text
            ...
            className="fill-emerald-700 text-[12px]"
          >
        ...
        <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-xl font-semibold">
              Flujo lineal con retroalimentación — Simulador
            </h1>
          </div>
          <div className="flex items-center gap-3">
        ...
        <section className="grid md:grid-cols-2 gap-6 items-center">
          <div className="p-5 bg-white rounded-2xl shadow-sm border">
            <h2 className="text-lg font-semibold mb-2">
              Del lineal rígido al sistema inteligente
            </h2>
            <p className="text-sm leading-relaxed text-slate-700">
              Finanzas deja de ser el final del flujo y devuelve inteligencia
              hacia Suministro, Operaciones y Logística para ajustar decisiones en ciclo continuo.
            </p>
            <ul className="mt-3 text-sm list-disc pl-5 space-y-1">
              <li>Márgenes: reducción de costos y mejora de eficiencia.</li>
              <li>Liquidez: capital de trabajo optimizado.</li>
        ...
        <section className="mt-6 grid lg:grid-cols-2 gap-6">
          <div className="p-5 bg-white rounded-2xl shadow-sm border">
            ...
            <p className="text-xs text-slate-500 mb-4">
              Ajusta los parámetros base para tu caso.
            </p>
          ...
          <div className="p-5 bg-white rounded-2xl shadow-sm border">
            ...
            <p className="text-xs text-slate-500 mb-4">
              Activa mejoras que Finanzas devuelve al resto del flujo.
            </p>
        ...
        <section className="mt-6 grid lg:grid-cols-3 gap-6">
          <div className="p-5 bg-white rounded-2xl shadow-sm border">
            <div className="flex items-center gap-2 mb-2">
              <TrendingUp className="w-5 h-5" /><h3 className="font-semibold">Márgenes</h3>
            </div>
          ...
          <div className="p-5 bg-white rounded-2xl shadow-sm border">
            <div className="flex items-center gap-2 mb-2">
              <Droplets className="w-5 h-5" /><h3 className="font-semibold">Liquidez</h3>
            </div>
            <table className="w-full text-sm">
              <tbody>
          ...
          <div className="p-5 bg-white rounded-2xl shadow-sm border">
            <div className="flex items-center gap-2 mb-2">
              <Rocket className="w-5 h-5" /><h3 className="font-semibold">ROI</h3>
            </div>
            <table className="w-full text-sm">
              <tbody>
        ...
        <section className="mt-6 p-5 bg-emerald-50 rounded-2xl border border-emerald-200">
          ...
          <div className="grid md:grid-cols-3 gap-4 text-sm">
            <div>
              ...
              <p>
                La retroalimentación ataca COGS y Opex en cada eslabón.
                Resultado: {pct((tuned.margenOperativo - base.margenOperativo) * 100)} en margen operativo
            ...
            <div>
              ...
              <p>
                Optimizar DIO/DSO/DPO acorta el ciclo de caja a {fmt(tuned.ccc)} días y libera{" "}
                {money(base.capitalTrabajo - tuned.capitalTrabajo)} de capital de trabajo.
              </p>
            </div>
            <div>
              <div className="font-semibold">ROI</div>
              <p>
                Más beneficio con menos inversión inmovilizada: ROI pasa de {pct(base.roi * 100)} a{" "}
                {pct(tuned.roi * 100)}.
              </p>
            </div>
          </div>
